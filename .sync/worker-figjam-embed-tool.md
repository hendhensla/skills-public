...
<td>`pageUrlOrId`</td>
<td>`string`</td>
<td>Target Notion page URL or page ID.</td>
</tr>
<tr>
<td>`figmaUrl`</td>
<td>`string`</td>
<td>HTTPS Figma or FigJam board, design, or file URL.</td>
</tr>
<tr>
<td>`afterBlockUrlOrId`</td>
<td>`string` (optional)</td>
<td>Block URL or ID after which to insert the embed. Omit to append to the end of the page.</td>
</tr>
</table>
Returns:
```json
