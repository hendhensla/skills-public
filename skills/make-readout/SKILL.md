...
description: >-
  ...
  state, use cases, timeline, usage, blockers, and next steps in one scannable
  page.
category:
  - Writing
  - Research
...
notes: >-
  ...
  and unknowns. Include usage state and active-member metrics when available.
  Never invent owners, dates, seat counts, or commercial facts when sources
