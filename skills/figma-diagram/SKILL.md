...
notion_row: 'https://app.notion.com/p/figma-diagram-3c098c21126881abb7d6fc4115ee3ac5'
notion_doc: 'https://app.notion.com/p/figma-diagram-3c098c21126881708ed7ffdcb2fba72b'
---
...
| Actor | Preferred image | Fallback |
| --- | --- | --- |
| Named human | Verified profile avatar from the loaded source | Neutral people or team illustration from `<your-image-library>` |
| Human role | Neutral role or team illustration from `<your-image-library>` | Generic user line icon |
| Custom agent | The agent's actual icon, read from your platform's agent-loading tool | Neutral AI illustration from `<your-image-library>`, labeled `Custom agent` |
| External AI agent or app | Official vendor logo or verified favicon | Labeled monogram |
| Generic system | Canonical line icon | Labeled monogram |
