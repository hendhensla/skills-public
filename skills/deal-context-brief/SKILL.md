---
name: deal-context-brief
skill: Deal Context Brief
description: >-
  Compile full historical context and next steps for a named deal from public
  research, CRM, calls, team chat, email, and internal deal records.
category:
  - Research
...
notes: >-
  ...
  skill for those questions. Treat missing loss reasons as unknown; never infer
  a platform rejection from an unexplained closed-lost record.
