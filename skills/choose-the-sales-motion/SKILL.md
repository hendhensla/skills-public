---
name: choose-the-sales-motion
skill: Choose the sales motion
description: >-
  Choose the correct sales motion for an account and translate account evidence
  into a workflow-first land, buying group, proof plan, and expansion path.
category:
  - Analysis
  - Reference
...
notes: >-
  ...
  Re-read your current approved sales-process source on each run and record
  which version was used. Replace the setup placeholders with your own sources.
setup: incomplete
notion_row: >-
