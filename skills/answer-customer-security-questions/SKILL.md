...
description: >-
  ...
  company's trust-portal source of truth, return source hyperlinks, handle trust-center
  access questions, add staged discovery questions, and calibrate flexibility to plan tier.
category:
  - Research
  - Reference
...
setup: pending
notes: >-
  Use for customer, prospect, deal, RFP, questionnaire, procurement, and security-review
  questions. Query the approved trust-portal connection and return source hyperlinks.
  Internal channels and docs provide context only, never customer-facing evidence.
notion_row: >-
